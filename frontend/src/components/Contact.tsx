...
import { ContactForm } from "../types"; // your form type
...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const templateParams = {
      ...
      user_phone: formData.phone,       // added phone
      service: formData.service,
      message: formData.message,
      to_email: "ramrasu2017@gmail.com", // your email
    };

    emailjs
      .send(
        "service_h29qohf",   // your EmailJS Service ID
        "template_kfcvq8d",  // your EmailJS Template ID
        templateParams,
        "pj_gtnwJObOAWWq_G"  // your EmailJS Public Key
      )
      .then(
        () => {
